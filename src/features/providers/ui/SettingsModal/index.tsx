...
import { getProviderMeta, type Provider, type ProviderId } from "../../contract/provider.js";
import ModalShell from "../../../../platform/renderer/components/shared/ModalShell";
import modalStyles from "../../../../platform/renderer/components/shared/ModalShell.module.css";
            ...
            <div className={styles.keyRow} key={provider.id}>
              <label className={modalStyles.field}>
                <span className={modalStyles.fieldLabel}>
                  {meta.label}
                  {configured && <span className={styles.configuredBadge}>Configured</span>}
                </span>
                <input
